        ...
        <div class="d-flex justify-content-center mt-5">
            <form action="insert.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="jumlahPemain" name="jumlah_pemain" required>
                </div>
                <div class="mb-3">
                    <label for="noLapangan" class="form-label">No. Lapangan</label>
                    <input type="number" class="form-control" id="noLapangan" name="no_lapangan" required>
                </div>
